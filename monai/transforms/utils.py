...
def get_transform_backends():
    """Get the backends of all MONAI_ transforms.
...
def print_transform_backends():
    """Prints a list of backends of all MONAI_ transforms."""
...
def resolves_modes(
    ...
    Args:
        ...
        kwargs: additional keyword arguments. currently support ``torch_interpolate_spatial_nd``, to provide
            ...
            ``use_compiled`` to use MONAI_'s precompiled backend (pytorch c++ extensions), default to ``False``.
    """
