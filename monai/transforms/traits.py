...
"""
A collection of generic traits for MONAI_ transforms.
"""
...
class LazyTrait:
    ...
    MONAI_'s lazy resampling feature. In order to do this, the implementing class needs
    to be able to describe its operation as an affine matrix or grid with accompanying metadata.
    This interface can be extended from by people adapting transforms to the MONAI_ framework as
    well as by implementors of MONAI_ transforms.
    """
...
class RandomizableTrait:
    ...
    can be extended from by people adapting transforms to the MONAI_ framework as well as by
    implementors of MONAI_ transforms.
    """
...
class MultiSampleTrait:
    ...
    extended from by people adapting transforms to the MONAI_ framework as well as by implementors
    of MONAI_ transforms.
    """
