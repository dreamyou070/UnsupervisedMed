...
"""
A collection of generic interfaces for MONAI_ transforms.
"""
...
class Transform(ABC):
    ...
    # Most of MONAI_ transform's inputs and outputs will be converted into torch.Tensor or monai.data.MetaTensor.
