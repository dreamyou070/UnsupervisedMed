...
def download(
    ...
    if repo_ is None:
        repo_ = "Project-MONAI_/model-zoo/hosting_storage_v1"
...
def _get_all_bundles_info(
    repo: str = "Project-MONAI_/model-zoo", tag: str = "dev", auth_token: str | None = None
...
def get_all_bundles_list(
    ...
    The default values of arguments correspond to the release of MONAI_ model zoo. In order to increase the
...
def get_bundle_versions(
    bundle_name: str, repo: str = "Project-MONAI_/model-zoo", tag: str = "dev", auth_token: str | None = None
...
def get_bundle_info(
    bundle_name: str,
    version: str | None = None,
    repo: str = "Project-MONAI_/model-zoo",
    tag: str = "dev",
...
def run_workflow(
    ...
    It can be MONAI_ existing bundle workflows or user customized workflows.
...
def _export(
    ...
    **kwargs: Any,
    ...
    if has_ignite:
        # here we use ignite Checkpoint to support nested weights and be compatible with MONAI_ CheckpointSaver
...
def push_to_hf_hub(
    ...
    **upload_folder_kwargs: Any,
    ...
    """
    Push a MONAI_ bundle to the Hugging Face Hub.
