...
TrainProperties = {
    ...
    "train_inferer": {
        BundleProperty.DESC: "MONAI_ Inferer object to execute the model computation in training.",
        BundleProperty.REQUIRED: True,
    ...
    "val_inferer": {
        BundleProperty.DESC: "MONAI_ Inferer object to execute the model computation in validation.",
        BundleProperty.REQUIRED: False,
...
InferProperties = {
    ...
    "inferer": {
        BundleProperty.DESC: "MONAI_ Inferer object to execute the model computation in inference.",
        BundleProperty.REQUIRED: True,
