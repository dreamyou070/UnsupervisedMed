...
class ComponentLocator:
    """
    Scan all the available classes and functions in the MONAI_ package and map them with the module paths in a table.
    ...
    def _find_classes_or_functions(self, modnames: Sequence[str] | str) -> dict[str, list]:
        ...
        """
        table: dict[str, list] = {}
        # all the MONAI_ modules are already loaded by `load_submodules`
