...
"""
Decorators and context managers for NVIDIA Tools Extension to profile MONAI_ components
"""
...
class Range:
    ...
    Args:
        ...
        methods: (only when used as decorator) the name of a method (or a list of the name of the methods)
            ...
            If None (default), the method(s) will be inferred based on the object's type for various MONAI_ components,
