...
class MBConvBlock(nn.Module):
    ...
    def __init__(
        ...
        # these are based on spatial dims and selected from MONAI_ factories
...
def drop_connect(inputs: torch.Tensor, p: float, training: bool) -> torch.Tensor:
    ...
    This function is generalized for MONAI_'s N-Dimensional spatial activations
...
def _get_same_padding_conv_nd(
    ...
    This function is generalized for MONAI_'s N-Dimensional spatial operations (e.g. Conv1D, Conv2D, Conv3D)
