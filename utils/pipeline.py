import inspect
import re
from typing import Callable, List, Optional, Union, Dict, Tuple, Any, Sequence, Iterable, Mapping, Type, cast
import numpy as np
import PIL.Image
import torch
...
class AnomalyDetectionStableDiffusionPipeline(StableDiffusionPipeline):
